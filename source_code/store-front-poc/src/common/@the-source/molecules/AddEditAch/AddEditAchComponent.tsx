...
const AddEditAchComponent = () => {
	...
	const _props = {
		...
		ach_payment_values: _.attempt(JSON.parse, decodeURIComponent(search_params.get('ach_payment_values') || '')),
	...
	return (
		<React.Fragment>
			<AddAchPaymentModal {..._props} handle_confirm={handle_confirm} close={handle_close} />
		</React.Fragment>
	);
};

export default AddEditAchComponent;
