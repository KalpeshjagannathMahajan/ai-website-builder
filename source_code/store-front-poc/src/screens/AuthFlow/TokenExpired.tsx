...
const useStyles = makeStyles((theme: any) => ({
	...
	layout: {
		...
		borderRadius: '3.2rem',
		...theme?.authflow?.token_expired_layout,
	},
	innerContainer: {
...
const TokenExpired = () => {
	...
	const illustrationImg = 'https://frontend-bucket.vercel.app/images/token_expired.svg';
					...
					<Grid className={styles.layout}>
						<Grid className={styles.innerContainer} container>
							...
							<Grid mt={'32px'} display='flex' justifyContent='center' width='100%'>
								<CustomText color={theme?.authflow?.expired_link?.color} type='H1' style={{ textAlign: 'center' }}>
