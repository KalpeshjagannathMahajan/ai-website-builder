...
const TerminalComp = ({ is_visible, currency }: Props) => {
	const theme: any = useTheme();
	const { setIsPolling, handle_drawer_state, transaction_data, set_is_terminal_modal_visible } = useContext(OrderManagementContext);
