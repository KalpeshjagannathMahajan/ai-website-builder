  ...
  return (
    <HeaderProvider>
      <div className="min-h-screen bg-white">
        ...
        <div className="sticky top-0 left-0 w-full z-[101] bg-white flex items-center justify-between px-12 py-4 shadow-sm">
        ...
        <section className="overflow-x-clip" id="home-hero">
          <div
            className="pt-28 lg:pt-254 lg:-mt-150 pb-115 relative"
            id="hero-content"
          >
            {/* Removed background effects for cleaner design */}
          ...
          <div className="container lg:contents !p-16 relative -mt-90">
            ...
            <div className="max-w-[812px] mx-auto z-[11] lg:z-[2]">
                      ...
                      <div className="border-t border-gray-100 bg-white">
                        ...
                        {extendBrandStyles && (
                          <div className="pb-10 transition-all duration-300 opacity-100">
                            <textarea
                              ...
                              className="w-full px-4 py-10 text-xs font-medium text-gray-700 bg-gray-50 rounded border border-gray-200 focus:border-[#16885f] focus:outline-none focus:ring-1 focus:ring-[#16885f] placeholder:text-gray-400 min-h-[80px] resize-none"
                            />
                          </div>
                        )}
                                ...
                                <button
                                  ...
                                  ${
                                    selectedStyle === style.id
                                      ? "bg-[#16885f] hover:bg-[#137a52] flex items-center justify-center button relative text-label-medium button-primary group/button rounded-10 p-8 text-accent-white active:scale-[0.995] border-0"
                        ...
                        >
                          ...
                          <select
                            ...
                            className={`px-3 py-2.5 text-xs font-medium text-gray-700 bg-white rounded border border-gray-200 focus:border-[#16885f] focus:outline-none focus:ring-1 focus:ring-[#16885f] ${
                          ...
                          {!extendBrandStyles && (
                            <input
                              type="text"
                              className="flex-1 px-3 py-2.5 text-xs font-medium text-gray-700 bg-gray-50 rounded border border-gray-200 focus:border-[#16885f] focus:outline-none focus:ring-1 focus:ring-[#16885f] placeholder:text-gray-400"
                        ...
                        {showInstructionsForIndex === index ? (
                          ...
                          <>
                            ...
                            <div className="flex gap-3 justify-center">
                              {/* Instant Clone Button - Green style */}
                              <button
                                onClick={(e) => {
                                  e.stopPropagation();
                                  handleSubmit(result);
                                }}
                                className="bg-[#16885f] hover:bg-[#137a52] flex items-center justify-center button relative text-label-medium button-primary group/button rounded-10 p-8 gap-2 text-white active:scale-[0.995]"
                              >
                                <div className="button-background absolute inset-0 rounded-10 pointer-events-none" />
                                <svg
                                  width="20"
